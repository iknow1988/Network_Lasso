...
def generateSyntheticData(G1):
    ...
    plt.savefig("Plots/Original_Grouping.png")
    plt.clf()
    
    plt.imshow(a_true_nodes, aspect='auto', interpolation='none', origin='lower')
    plt.colorbar()
    plt.savefig("Plots/Original_Grouping_nodes.png")
    plt.clf()
    ...
    plt.colorbar()
    plt.savefig("Plots/Original_Grouping_nodes_Similarity.png")
    plt.clf()
...
def main():
    ...
    for lamb in lambdas:
        ...
        if not os.path.exists("Plots/Time"):
            os.makedirs("Plots/Time")
        if not os.path.exists("Plots/Iterations"):
            os.makedirs("Plots/Iterations")
        ...
        plt.legend()
        plt.savefig("Plots/Accuracies/"+ str(lamb) +".png")
        plt.clf()
        
        plt.plot(pl5, pl4)
        plt.xlabel('$\lambda$')
        plt.ylabel('Time (minutes)')
        plt.savefig("Plots/Time/"+ str(lamb) +".png")
        plt.clf()
        
        plt.plot(pl5, pl3)
        plt.xlabel('$\lambda$')
        plt.ylabel('Iterations')
        plt.savefig("Plots/Iterations/"+ str(lamb) +".png")
        plt.clf()
